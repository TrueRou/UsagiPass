...
onMounted(() => {
  ...
  QRCode.toDataURL('SGWCMAID24100712463402DF0E42D87CF696FFE73C5456F2787AE81CDAD1CEA0337DE1CC17D6BEDDC56C', qrcodeOpts, (err, url) => {
...
<template>
  ...
  <div id="background" class="flex flex-col items-center justify-center h-full w-full">
    <img id="card-bg" class="h-full absolute object-cover -z-30" src="../assets/base/UI_CardBase_0000002_000001.png">
  ...
  <div id="overlay" class="absolute h-full top-0" :style="overlayStyle">
    ...
    <img id="overlay-chara" class="absolute object-cover bottom-0 -z-20" src="../assets/chara/UI_CardChara_000201.png">
    <div id="overlay-user-info" class="absolute bg-white right-0 flex flex-col rounded-md pt-1" :style="userInfoStyle">
    ...
    <div id="overlay-chara-info" class="absolute flex flex-col left-0 items-center" style="width: 100%; bottom: 1.6%;">
      <div class="flex justify-between pt-1 pb-1 rounded-2xl bg-gray-800 text-white opacity-85"
        ...
        <p style="font-size: 1.6vh; font-family: FOTSeurat; line-height: 120%;">5018 1798 0608 6771 9414</p>
        <p style="font-size: 1.6vh; font-family: FOTSeurat; line-height: 120%;">[maimaiDX]1.45-0001</p>
      </div>
    </div>
