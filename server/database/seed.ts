    ...
    await db.insert(schema.server).values([
        {
            ...
            tipsTitle: '水鱼查分器使用指南',
            tipsDesc: '如果您没有使用过水鱼查分器，开始之前，建议您先注册一个查分器账户。然后就可以利用UsagiPass代理快速导入您的成绩。\n如果您使用过水鱼查分器，登录水鱼后，点击编辑个人资料，复制成绩导入Token，填入下方即可。',
        ...
        },
        {
            ...
            identifier: 'lxns',
            tipsTitle: '落雪查分器使用指南',
            tipsDesc: '使用落雪查分器之前，请先注册落雪账号，并且使用落雪官方至少上传一次成绩。\n完成后，进入 账号详情 - 第三方应用 - 个人 API 密钥，复制个人 API 密钥填入下方即可。',
