...
from usagipass.app.database import init_db, session_ctx
...
async def main():
    ...
    kinds = ["background", "frame", "character", "passname", "mask"]
    tasks = [asyncio.to_thread(import_images, kind) for kind in kinds]
