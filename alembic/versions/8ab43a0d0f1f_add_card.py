...
Revision ID: 8ab43a0d0f1f
Revises: 9cdcf6f8ca8c
Create Date: 2025-03-05 14:36:19.937029
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_cards_cid"), "cards", ["cid"], unique=True)
    ...
    op.create_foreign_key(None, "user_preferences", "images", ["character_id"], ["id"])
    op.create_foreign_key(None, "user_preferences", "images", ["frame_id"], ["id"])
    op.create_foreign_key(None, "user_preferences", "images", ["passname_id"], ["id"])
    op.create_foreign_key(None, "user_preferences", "images", ["background_id"], ["id"])
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, "user_preferences", type_="foreignkey")
    op.drop_constraint(None, "user_preferences", type_="foreignkey")
    op.create_foreign_key("user_preferences_ibfk_4", "user_preferences", "images", ["passname_id"], ["id"], onupdate="RESTRICT", ondelete="RESTRICT")
    op.create_foreign_key("user_preferences_ibfk_3", "user_preferences", "images", ["frame_id"], ["id"], onupdate="RESTRICT", ondelete="RESTRICT")
    op.create_foreign_key(
        "user_preferences_ibfk_2", "user_preferences", "images", ["background_id"], ["id"], onupdate="RESTRICT", ondelete="RESTRICT"
    )
    op.create_foreign_key("user_preferences_ibfk_1", "user_preferences", "images", ["character_id"], ["id"], onupdate="RESTRICT", ondelete="RESTRICT")
    ...
    op.drop_index(op.f("ix_cards_cid"), table_name="cards")
    op.drop_table("cards")
