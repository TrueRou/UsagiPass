...
UsagiPass 支持从公众号同步你的成绩并更新至 UsagiLab 通行证绑定的查分器，且在系统缺少证书的状态下仍可工作，假如你不想安装证书或证书已安装但无效时还可有限地使用 UsagiPass。在完成第二步[配置代理软件](#第二步-配置代理软件)后：
